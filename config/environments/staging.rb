Halalgems::Application.configure do
  ...
  CURRENT_HOST = "staging.halalgems.com"
  ...
  # config.action_controller.asset_host = "halalgems.com/staging"
  ...
  config.after_initialize do
    ...
    paypal_options = {
      :login => "halalgems_staging_api1.nexlesoft.com",
      :password => "1397803121",
      :signature => "AFcWxV21C7fd0v3bYYYRCpSSRl31A6ggQdcM3qk9LsH5i6C7TIU--syy"
    }
