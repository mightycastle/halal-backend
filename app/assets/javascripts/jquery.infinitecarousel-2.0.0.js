	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			if(o.displayProgressBar)
			{
				...
				$('#progress'+randID).width('100%').height(5).css('opacity','.5');
			}
			...
			for(i=1;i<=o.inView;i++)
			{
				...
				$('#textholder'+randID+'_'+i).height(imgHeight*o.textholderHeight).css({'backgroundColor':'#EEE','opacity':'0.8'});
