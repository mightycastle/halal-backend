...
(function (f) {
  ...
  if (/1\.(0|1|2|3|4)\.(0|1)/.test(f.fn.jquery) || /^1.1/.test(f.fn.jquery) || /^1.2/.test(f.fn.jquery) || /^1.3/.test(f.fn.jquery)) alert("tn3gallery requires jQuery v1.4.2 or later!  You are using v" + f.fn.jquery);
    ...
    f.fn.tn3.version = "1.3.0.50";
    f.fn.tn3.config = {
      data: null,
      skin: null,
      skinDir: "skins",
      skinDefault: '<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img url="/assets/preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
      cssID: null
    };
  ...
  f.extend(f.easing, {
    ...
    easeInOutElastic: function (c, a, d, b, e) {
      ...
      if (k < Math.abs(b)) {
        k = b;
        c = g / 4
      } else c = g / (2 * Math.PI) * Math.asin(b / k); if (a < 1) return -0.5 * k * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * e - c) * 2 * Math.PI / g) + d;
    ...
    easeInOutBounce: function (c, a, d, b, e) {
      ...
      return f.easing.easeOutBounce(c, a * 2 - e, 0, b, e) * 0.5 + b *
        0.5 + d
    }
  })
})(jQuery);
  ...
  f.fn.tn3.Gallery.prototype = {
    ...
    init: function (c, a) {
      ...
      if (!(this.loader.reqs > 0 || this.data.length == 0 || a)) {
        ...
        this.$tn3.css("float", "left").css("overflow", "hidden");
        d.wDif = this.$tn3.outerWidth(true) - d.width;
        d.hDif = this.$tn3.outerHeight(true) - d.height;
        this.replaceMenu("halalgemss.com", "http://halalgems.com");
        var b = this;
        ...
        this.config.responsive !==
          false && this.initResponsive(this.config.responsive);
    ...
    parseLayout: function () {
      ...
      this.$c.find("div[class^='" + a.cssID + "-']").each(function () {
        ...
        else j != "gallery" && k.remove(); if (k.parent().hasClass(a.cssID + "-image")) {
          if (!g.$inImage) {
            g.$inImage = k.parent().append('<div class="tn3-in-image"></div>').find(":last");
            if (f.browser.msie) {
              var h = f("<div />");
              h.css("background-color", "#D2E4ED").css("opacity", -1).css("width", "100%").css("height", "100%");
              h.appendTo(g.$inImage)
            }
            g.$inImage.css("position", "absolute").css("overflow", "hidden").width(c.image.width()).height(c.image.height())
          }
      ...
      var n = f('<div title="Nexle"></div>');
      n.css("position", "absolute");
      n.click(function () {
        window.location = "http://nexlesoft.com"
      }).hover(function () {
    ...
    resize: function (c, a) {
      ...
      if (this.items.albums) {
        ...
        g = this.albums.initValues.height +
          b;
...
(function (f) {
  ...
  f.fn.tn3.Imager.prototype = {
    ...
    show: function (c) {
      if (this.isInTransition) this.qid = c;
        ...
        if (c == "next") {
          ...
          this.side = "right"
        } else this.side = this.active > c ? "right" : "left"; if (this.data[c]) {
    ...
    onTransitionEnd: function () {
      ...
      if (this.mouseCoor.x >= c.left && this.mouseCoor.x <= c.left + this.$binder.width())
...
(function (f) {
  ...
  f.fn.tn3.Thumbnailer.prototype = {
    ...
    onLoadThumb: function (c, a, d, b) {
      ...
      if (this.nloaded < this.data.length) {
        ...
        if (!this.config.seqLoad)
          for (c = 0; c < this.lis.length; c++) this.lis[c].pos = this.lis[c].li.position()[this.edge];
        this.thumbsLoaded()
    ...
    thumbClick: function (c) {
      ...
      else this.initThumb(this.active); if (c == "next") c = this.active + 1 < this.data.length ? this.active + 1 : 0;
    ...
    mouseenter: function () {
      ...
      c.intID = this.listSize > this.containerSize && this.config.overMove ?
    ...
    this.end = f.proxy(g, k)
      ...
      flatSort: function (d) {
        for (var b = [], e = 0; e < this.gs.length; e++)
          for (var g =
            0; g < this.gs[e].length; g++) b.push(this.gs[e][g]);
        d && b.reverse();
        return b
      },
      randomSort: function () {
      ...
      animateGrid: function (d, b, e, g, k, j, n) {
        ...
        for (e = 0; e < d.length; e++) {
          ...
          if (f.isArray(d[e]))
            for (var l in d[e]) d[e][l].delay(g).animate(b[e], h);
...
(function (f) {
  function c(h) {
    ...
    var l = h.baseZ,
      ...
      p = f('<div class="blockUI ' + h.cssID + '-overlay" style="z-index:' +
    ...
    q =
      k && (!f.boxModel || f("object,embed", null).length > 0);
    if (j || q) {
